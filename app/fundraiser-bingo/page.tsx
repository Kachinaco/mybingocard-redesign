...
export default function Fundraiser_bingoPage() {
  return (
    <PlayfulShell>
      ...
      <section class="hero">
        <div class="content-rail hero-grid">
          <div class="hero-copy">
            <nav class="breadcrumbs" aria-label="Breadcrumbs"><a href="/" data-route class="">Home</a><span aria-hidden="true">/</span><a href="/bingo-games" data-route class="">Bingo games</a><span aria-hidden="true">/</span><span>Fundraiser bingo</span></nav>
            <span class="pill pill-local">Groups and community</span>
            <h1>Fundraiser bingo</h1>
            <p>Printable and hosted bingo for auctions, raffles, schools, and benefit events.</p>
            <div class="button-row">
              <a href="/create?templateId=fundraiser-bingo" data-route class="button button-primary">Make this card <svg aria-hidden="true" focusable="false" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M14 7l5 5-5 5"/></svg></a>
      ...
      <div class="bingo-card" data-bingo-preview>
        <div class="bingo-card-title">
          <strong data-preview-title>Fundraiser bingo</strong>
      ...
      <article class="card-soft feature-card">
        ...
        <p class="muted">Begin with prompts shaped for fundraiser bingo, then replace anything that does not fit your group.</p>
      </article>
      ...
      <section class="page-section surface-purple">
        <div class="content-rail article-layout">
          <article class="article-body">
            ...
            <h2>What belongs on a fundraiser bingo card?</h2>
      ...
      <section class="page-section">
        <div class="content-rail">
          ...
          <div class="template-grid">
            <a class="card-soft template-card" href="/church-bingo" data-route><span class="template-emoji" aria-hidden="true">✨</span><h3>Church bingo</h3><p class="muted">Custom bingo-card ideas for church groups, ministries, and community events.</p></a>
          
            <a class="card-soft template-card" href="/icebreaker-bingo" data-route><span class="template-emoji" aria-hidden="true">✨</span><h3>Icebreaker bingo</h3><p class="muted">Find-someone-who prompts for networking, classrooms, groups, and workshops.</p></a>
          </div>
        </div>
      </section>
    `
