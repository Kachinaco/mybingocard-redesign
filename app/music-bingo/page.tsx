...
export default function Music_bingoPage() {
  return (
    <PlayfulShell>
      ...
      <section class="hero">
        <div class="content-rail hero-grid">
          <div class="hero-copy">
            <nav class="breadcrumbs" aria-label="Breadcrumbs"><a href="/" data-route class="">Home</a><span aria-hidden="true">/</span><a href="/bingo-games" data-route class="">Bingo games</a><span aria-hidden="true">/</span><span>Music bingo</span></nav>
            <span class="pill pill-local">Events and occasions</span>
            <h1>Music bingo</h1>
            <p>Song, artist, and genre bingo for parties, classrooms, and hosted events.</p>
            <div class="button-row">
              <a href="/create?templateId=music-bingo" data-route class="button button-primary">Make this card <svg aria-hidden="true" focusable="false" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M14 7l5 5-5 5"/></svg></a>
      ...
      <div class="bingo-card" data-bingo-preview>
        <div class="bingo-card-title">
          <strong data-preview-title>Music bingo</strong>
      ...
      <article class="card-soft feature-card">
        ...
        <p class="muted">Begin with prompts shaped for music bingo, then replace anything that does not fit your group.</p>
      </article>
      ...
      <section class="page-section surface-purple">
        <div class="content-rail article-layout">
          <article class="article-body">
            ...
            <h2>What belongs on a music bingo card?</h2>
