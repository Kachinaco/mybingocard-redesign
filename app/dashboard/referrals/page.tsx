    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-slate-500 font-medium">Loading referral data...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="mb-10 animate-fade-in-up">
            <h1 className="text-3xl font-bold text-slate-900">
              Refer a <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-600 to-indigo-600">Friend</span>
            </h1>
          ...
          {data && (
            <>
              {/* Referral Link Card */}
              <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 md:p-8 mb-8 animate-fade-in-up animation-delay-100 relative overflow-hidden">
                <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-violet-50 to-indigo-50 rounded-full blur-3xl opacity-50 -mr-16 -mt-16 pointer-events-none"></div>

                <div className="relative z-10">
                  <h2 className="text-xl font-bold text-slate-900 mb-2">Your Referral Link</h2>
                  <p className="text-slate-500 text-sm mb-6">
                    Share this link with friends. When they sign up, they will be tracked as your referral.
                  </p>

                  <div className="flex flex-col sm:flex-row gap-3">
                    <div className="flex-1 px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-slate-700 font-mono text-sm truncate">
                      {data.referralLink}
                    </div>
                    <button
              ...
              <div className="grid grid-cols-3 gap-4 mb-8 animate-fade-in-up animation-delay-150">
                <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-5 text-center">
                  <p className="text-3xl font-black text-indigo-600">{data.stats.total}</p>
                  <p className="text-xs font-medium text-slate-500 uppercase tracking-wide mt-1">Total Referrals</p>
                </div>
                <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-5 text-center">
                  <p className="text-3xl font-black text-emerald-600">{data.stats.signedUp}</p>
                  <p className="text-xs font-medium text-slate-500 uppercase tracking-wide mt-1">Signed Up</p>
                </div>
                <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-5 text-center">
                  <p className="text-3xl font-black text-amber-600">{data.stats.rewarded}</p>
                  <p className="text-xs font-medium text-slate-500 uppercase tracking-wide mt-1">Rewarded</p>
                </div>
              </div>

              {/* Referrals Table */}
              <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 md:p-8 animate-fade-in-up animation-delay-200">
                <h2 className="text-xl font-bold text-slate-900 mb-6">Your Referrals</h2>
                    ...
                    <table className="w-full text-sm">
                      <thead>
                        <tr className="border-b border-slate-100">
                          <th className="text-left py-3 px-2 font-semibold text-slate-500 uppercase tracking-wide text-xs">Email</th>
                          <th className="text-left py-3 px-2 font-semibold text-slate-500 uppercase tracking-wide text-xs">Status</th>
