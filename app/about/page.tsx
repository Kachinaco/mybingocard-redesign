        ...
        <div class="content-rail">
          <div class="article-layout">
            <article class="article-body">
              ...
              <p>Every important action says what happens next. Private and public states are visible, paid choices are explained before checkout, and local prototype screens clearly distinguish demonstration data from real customer data.</p>
            ...
            <aside class="card-soft article-aside">
              <span class="eyebrow">In this redesign</span>
              ...
              <button class="button button-small" type="button" data-action="open-routes">Browse all screens</button>
            </aside>
          </div>
        </div>
      </section>
