...
export const metadata: Metadata = {
  ...
  description:
    "Create custom Christmas and holiday bingo cards with an easy bingo card maker. Build holiday cards for classrooms, family gatherings, and office parties, then export an individual PDF or PNG for free.",
  alternates: {
...
const schema = {
  ...
  description:
    "Christmas and holiday bingo card maker with editable square ideas and individual printable exports for classrooms, family gatherings, and office parties.",
    ...
    <div className="relative">
      ...
      <div className="relative bg-white rounded-2xl border-[2.5px] border-[#33312e] shadow-[0_6px_0_#33312e] p-6 transform rotate-2 hover:rotate-0 transition-all duration-500">
        <div className="text-center mb-4">
          ...
          <p className="text-[#a39a88] text-xs uppercase tracking-widest font-bold mt-2">🎄 Holiday Edition</p>
        </div>
              ...
              <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                <div className="text-center lg:text-left animate-fade-in-up">
                  <div className="inline-flex items-center gap-2 bg-white border-2 border-[#33312e] shadow-[0_2px_0_#33312e] rounded-full px-4 py-1.5 mb-8">
                    <span className="text-xs font-heading font-semibold text-[#5b3fd4] uppercase tracking-wide">🎄 Holiday Season</span>
                  </div>
                  ...
                  <p className="text-lg font-semibold text-[#6b6459] mb-8 leading-relaxed max-w-xl mx-auto lg:mx-0">
                    Spread holiday cheer with editable Christmas and holiday bingo cards for classroom parties, family gatherings, ugly-sweater events, and office celebrations. Start with Santa, reindeer, snowflakes, candy canes, or your own traditions, save one card, and export an individual PDF or PNG for free. Use a paid batch pack for unique printable cards or paid player links for virtual parties.
                  </p>
                  ...
                  <p className="text-sm font-semibold text-[#a39a88]">1 free saved card · Festive themes · Individual PDF/PNG export</p>
                </div>
          ...
          <section className="cband cband-purple py-24 relative overflow-hidden">
            <div className="container mx-auto px-4 relative z-10 text-center">
              ...
              <p className="text-xl font-semibold text-white/85 mb-10 max-w-2xl mx-auto">
                Make a holiday bingo card in under 2 minutes, then use a paid batch pack when the celebration needs unique printable cards.
              </p>
