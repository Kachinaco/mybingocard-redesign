...
export default function Baby_shower_gift_bingoPage() {
  return (
    <PlayfulShell>
      ...
      <section class="hero">
        <div class="content-rail hero-grid">
          <div class="hero-copy">
            <nav class="breadcrumbs" aria-label="Breadcrumbs"><a href="/" data-route class="">Home</a><span aria-hidden="true">/</span><a href="/bingo-games" data-route class="">Bingo games</a><span aria-hidden="true">/</span><span>Baby shower gift bingo</span></nav>
            <span class="pill pill-local">Events and occasions</span>
            <h1>Baby shower gift bingo</h1>
            <p>Gift-opening bingo built around common baby items and registry surprises.</p>
            <div class="button-row">
              <a href="/create?templateId=baby-shower-gift-bingo" data-route class="button button-primary">Make this card <svg aria-hidden="true" focusable="false" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M14 7l5 5-5 5"/></svg></a>
      ...
      <div class="bingo-card" data-bingo-preview>
        <div class="bingo-card-title">
          <strong data-preview-title>Baby shower gift bingo</strong>
      ...
      <article class="card-soft feature-card">
        ...
        <p class="muted">Begin with prompts shaped for baby shower gift bingo, then replace anything that does not fit your group.</p>
      </article>
      ...
      <section class="page-section surface-purple">
        <div class="content-rail article-layout">
          <article class="article-body">
            ...
            <h2>What belongs on a baby shower gift bingo card?</h2>
      ...
      <section class="page-section">
        <div class="content-rail">
          ...
          <div class="template-grid">
            ...
            <a class="card-soft template-card" href="/birthday-bingo" data-route><span class="template-emoji" aria-hidden="true">✨</span><h3>Birthday bingo</h3><p class="muted">Custom birthday bingo cards for children, adults, milestones, and family celebrations.</p></a>
          </div>
        </div>
      </section>
    `
