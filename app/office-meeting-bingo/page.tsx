...
export default function Office_meeting_bingoPage() {
  return (
    <PlayfulShell>
      ...
      <section class="hero">
        <div class="content-rail hero-grid">
          <div class="hero-copy">
            <nav class="breadcrumbs" aria-label="Breadcrumbs"><a href="/" data-route class="">Home</a><span aria-hidden="true">/</span><a href="/bingo-games" data-route class="">Bingo games</a><span aria-hidden="true">/</span><span>Office meeting bingo</span></nav>
            <span class="pill pill-local">Teams and work</span>
            <h1>Office meeting bingo</h1>
            <p>Light meeting bingo for recurring phrases, remote calls, and team rituals.</p>
            <div class="button-row">
              <a href="/create?templateId=office-meeting-bingo" data-route class="button button-primary">Make this card <svg aria-hidden="true" focusable="false" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M14 7l5 5-5 5"/></svg></a>
      ...
      <div class="bingo-card" data-bingo-preview>
        <div class="bingo-card-title">
          <strong data-preview-title>Office meeting bingo</strong>
      ...
      <article class="card-soft feature-card">
        ...
        <p class="muted">Begin with prompts shaped for office meeting bingo, then replace anything that does not fit your group.</p>
      </article>
      ...
      <section class="page-section surface-purple">
        <div class="content-rail article-layout">
          <article class="article-body">
            ...
            <h2>What belongs on a office meeting bingo card?</h2>
      ...
      <section class="page-section">
        <div class="content-rail">
          ...
          <div class="template-grid">
            ...
            <a class="card-soft template-card" href="/onboarding-bingo" data-route><span class="template-emoji" aria-hidden="true">✨</span><h3>Onboarding bingo</h3><p class="muted">Interactive onboarding prompts for tools, people, policies, and first-week milestones.</p></a>
          </div>
        </div>
      </section>
    `
