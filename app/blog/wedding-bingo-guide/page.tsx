...
export const metadata: Metadata = {
  title: "The ultimate wedding bingo guide",
};

export default function BlogWedding_bingo_guidePage() {
  return (
    <PlayfulShell>
      ...
      <section class="page-section">
        <div class="content-rail article-layout">
          <article class="article-body">
            <nav class="breadcrumbs" aria-label="Breadcrumbs"><a href="/" data-route class="">Home</a><span aria-hidden="true">/</span><a href="/blog" data-route class="">Blog</a><span aria-hidden="true">/</span><span>The ultimate wedding bingo guide</span></nav>
            <span class="pill pill-purple">Practical guide · 6 minute read</span>
            <h1>The ultimate wedding bingo guide</h1>
            <p class="muted" style="font-size:1.12rem">Planning guidance, square ideas, printing tips, and reception-play advice.</p>
