...
export const metadata: Metadata = {
  title: "15 fun classroom bingo ideas",
};

export default function BlogFun_classroom_bingo_ideasPage() {
  return (
    <PlayfulShell>
      ...
      <section class="page-section">
        <div class="content-rail article-layout">
          <article class="article-body">
            <nav class="breadcrumbs" aria-label="Breadcrumbs"><a href="/" data-route class="">Home</a><span aria-hidden="true">/</span><a href="/blog" data-route class="">Blog</a><span aria-hidden="true">/</span><span>15 fun classroom bingo ideas</span></nav>
            <span class="pill pill-purple">Practical guide · 6 minute read</span>
            <h1>15 fun classroom bingo ideas</h1>
            <p class="muted" style="font-size:1.12rem">Classroom bingo ideas for vocabulary, math, science, and student participation.</p>
