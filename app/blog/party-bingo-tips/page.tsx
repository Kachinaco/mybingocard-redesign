...
export const metadata: Metadata = {
  title: "How to run the perfect party bingo game",
};

export default function BlogParty_bingo_tipsPage() {
  return (
    <PlayfulShell>
      ...
      <section class="page-section">
        <div class="content-rail article-layout">
          <article class="article-body">
            <nav class="breadcrumbs" aria-label="Breadcrumbs"><a href="/" data-route class="">Home</a><span aria-hidden="true">/</span><a href="/blog" data-route class="">Blog</a><span aria-hidden="true">/</span><span>How to run the perfect party bingo game</span></nav>
            <span class="pill pill-purple">Practical guide · 6 minute read</span>
            <h1>How to run the perfect party bingo game</h1>
            <p class="muted" style="font-size:1.12rem">Hosting advice for setup, calling, prizes, pacing, and keeping guests involved.</p>
