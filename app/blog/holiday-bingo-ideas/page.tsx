...
export const metadata: Metadata = {
  ...
  description:
    "Creative holiday bingo card ideas for Christmas parties, Hanukkah celebrations, New Year gatherings, and winter events. Draft custom cards, then save and export with free access.",
