...
export const metadata: Metadata = {
  title: "Online bingo card generator",
};

export default function Online_bingo_card_generatorPage() {
  return (
    <PlayfulShell>
      ...
      <section class="hero">
        <div class="content-rail hero-grid">
          <div class="hero-copy">
            <nav class="breadcrumbs" aria-label="Breadcrumbs"><a href="/" data-route class="">Home</a><span aria-hidden="true">/</span><a href="/bingo-games" data-route class="">Bingo games</a><span aria-hidden="true">/</span><span>Online bingo card generator</span></nav>
            <span class="pill pill-local">Custom generator</span>
            <h1>Online bingo card generator</h1>
            <p>Make digital bingo cards that players can open and mark from their own devices.</p>
            <div class="button-row">
              <a href="/create?templateId=online-bingo-card-generator" data-route class="button button-primary">Make this card <svg aria-hidden="true" focusable="false" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M14 7l5 5-5 5"/></svg></a>
      ...
      <div class="bingo-card" data-bingo-preview>
        <div class="bingo-card-title">
          <strong data-preview-title>Online bingo card generator</strong>
      ...
      <article class="card-soft feature-card">
        ...
        <p class="muted">Begin with prompts shaped for online bingo card generator, then replace anything that does not fit your group.</p>
      </article>
      ...
      <section class="page-section surface-purple">
        <div class="content-rail article-layout">
          <article class="article-body">
            ...
            <h2>What belongs on a online bingo card generator card?</h2>
      ...
      <section class="page-section">
        <div class="content-rail">
          ...
          <div class="template-grid">
            ...
            <a class="card-soft template-card" href="/custom-bingo-card-maker" data-route><span class="template-emoji" aria-hidden="true">✨</span><h3>Custom bingo card maker</h3><p class="muted">Design personalized bingo cards with custom squares, grid sizes, colors, and themes.</p></a>
          </div>
        </div>
      </section>
    `
