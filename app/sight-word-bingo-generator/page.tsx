...
export const metadata: Metadata = {
  title: "Sight-word bingo generator",
};

export default function Sight_word_bingo_generatorPage() {
  return (
    <PlayfulShell>
      ...
      <section class="hero">
        <div class="content-rail hero-grid">
          <div class="hero-copy">
            <nav class="breadcrumbs" aria-label="Breadcrumbs"><a href="/" data-route class="">Home</a><span aria-hidden="true">/</span><a href="/bingo-games" data-route class="">Bingo games</a><span aria-hidden="true">/</span><span>Sight-word bingo generator</span></nav>
            <span class="pill pill-local">Classroom-ready</span>
            <h1>Sight-word bingo generator</h1>
            <p>Early-literacy bingo for sight-word recognition and small-group reading practice.</p>
            <div class="button-row">
              <a href="/create?templateId=sight-word-bingo-generator" data-route class="button button-primary">Make this card <svg aria-hidden="true" focusable="false" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M14 7l5 5-5 5"/></svg></a>
      ...
      <div class="bingo-card" data-bingo-preview>
        <div class="bingo-card-title">
          <strong data-preview-title>Sight-word bingo generator</strong>
      ...
      <article class="card-soft feature-card">
        ...
        <p class="muted">Begin with prompts shaped for sight-word bingo generator, then replace anything that does not fit your group.</p>
      </article>
      ...
      <section class="page-section surface-purple">
        <div class="content-rail article-layout">
          <article class="article-body">
            ...
            <h2>What belongs on a sight-word bingo generator card?</h2>
      ...
      <section class="page-section">
        <div class="content-rail">
          ...
          <div class="template-grid">
            <a class="card-soft template-card" href="/back-to-school-bingo" data-route><span class="template-emoji" aria-hidden="true">✨</span><h3>Back-to-school bingo</h3><p class="muted">First-week classroom bingo for names, routines, supplies, and student icebreakers.</p></a>
          
            <a class="card-soft template-card" href="/classroom-bingo" data-route><span class="template-emoji" aria-hidden="true">✨</span><h3>Classroom bingo</h3><p class="muted">Flexible classroom bingo for lessons, review activities, and student participation.</p></a>
          
            <a class="card-soft template-card" href="/end-of-year-bingo" data-route><span class="template-emoji" aria-hidden="true">✨</span><h3>End-of-year bingo</h3><p class="muted">A classroom wrap-up activity for memories, milestones, review, and celebration.</p></a>
          </div>
        </div>
      </section>
    `
