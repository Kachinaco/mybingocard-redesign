    ...
    <header className="fixed top-0 left-0 right-0 w-full max-w-full z-50 overflow-x-clip bg-white/80 backdrop-blur-md border-b border-slate-200/50">
      <div className="container mx-auto max-w-full px-4 lg:px-8 h-16 flex items-center justify-between gap-3">
        ...
        <nav className="hidden md:flex items-center gap-6">
          ...
          <Link href="/bingo-games" className="text-sm font-medium text-slate-600 hover:text-indigo-600 transition-colors">
            Bingo Games
          </Link>
      ...
      {open && (
        <div className="md:hidden bg-white border-t border-slate-100 shadow-lg">
          <div className="container mx-auto px-4 py-4 flex flex-col gap-1">
            ...
            <Link href="/bingo-games" onClick={() => setOpen(false)} className="py-3 px-2 text-slate-700 font-medium hover:text-indigo-600 transition-colors">
              Bingo Games
            </Link>
