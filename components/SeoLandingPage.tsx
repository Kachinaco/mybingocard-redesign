    ...
    <header className="fixed top-0 w-full z-50 bg-white/85 backdrop-blur-md border-b border-slate-200/70">
      <div className="container mx-auto px-4 lg:px-8 h-16 flex items-center justify-between gap-3">
        <Link href="/" className="min-w-0 flex items-center gap-2 group">
          ...
          <span className="hidden min-[390px]:inline truncate text-xl font-bold text-slate-900">MyBingoCard</span>
        </Link>
        <Link
          href={createHref}
          className="md:hidden shrink-0 rounded-lg bg-gradient-to-r from-violet-600 to-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm transition hover:shadow-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
        >
          Create Card
        </Link>
